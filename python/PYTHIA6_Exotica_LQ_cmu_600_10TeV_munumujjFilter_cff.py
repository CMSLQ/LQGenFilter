...
configurationMetadata = cms.untracked.PSet(
        ...
        name = cms.untracked.string('$Source: /cvs_server/repositories/CMSSW/UserCode/Leptoquarks/LQGenFilter/python/PYTHIA6_Exotica_LQ_cmu_600_10TeV_munumujjFilter_cff.py,v $'),
